package com.youzheng.zhejiang.financebooking.Thrid.network;
...
import com.youzheng.zhejiang.financebooking.FinanceApp;
...
public class OkHttpClientManager
{
    ...
    private void  _postAsynJson(String type, String url, final StringCallback callback)
    {
        ...
        String accessToken = (String) SharedPreferencesUtils.getParam(FinanceApp.financeApp,SharedPreferencesUtils.token,"");
        Request request = null ;
        if (!accessToken.equals("")){
            request = new Request.Builder().addHeader("Authorization",accessToken).url(url).post(requestBody).build();
        }else {
